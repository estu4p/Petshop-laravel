                ...
                <form class="w-full" action="{{ route('dashboard.product.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                      <div class="w-full px-3">
                          ...
                          <input name="file" type="file" accept="image/*" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" placeholder="Photos">
                      </div>
                    </div>
                    {{-- End Foto --}}
                    <div class="flex flex-wrap -mx-3 mb-6">
