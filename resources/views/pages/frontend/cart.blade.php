    ...
    <section class="py-7 pl-10">
      <div class="container mx-auto">
        <ul class="flex text-xl">
          <li>
            <a class="mr-3 font-light" href="index.html">Home</a>
          </li>
          <span class="mr-3">/</span>
          <li>
            <a class="font-semibold" href="#" aria-label="current-page">Shopping Cart</a>
          </li>
        </ul>
      </div>
    </section>
        ...
        <div class="flex -mx-4 flex-wrap">
          <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
            ...
            @forelse ($carts as $item)
              ...
              >
                <div class="px-4 flex-none">
                  <div class="" style="width: 90px; height: 90px">
                    <img
                      src="{{ Storage::url($item->product->photo_url) }}"
                      alt="chair-1"
              ...
              <!-- END: ROW 1 -->
            @empty
              <p id="cart-empty" class="text-center py-8"> {{-- hidden --}}
                Ooops... Cart is empty
          ...
          <div class="w-full md:px-4 md:w-4/12" id="shipping-detail">
            <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
              ...
              @csrf
                ...
                <div class="flex flex-col mb-4">
                  ...
                  <div class="flex -mx-2 flex-wrap">
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/frontend/img/logo-fedex.svg"
                          alt="Logo Fedex"
                ...
                <div class="flex flex-col mb-4">
                  ...
                  <div class="flex -mx-2 flex-wrap">
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/frontend/img/logo-midtrans.png"
                          alt="Logo midtrans"
                          class="object-contain max-h-full"
                        />
                      </button>
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/frontend/img/logo-mastercard.svg"
                          alt="Logo mastercard"
                        />
                      </button>
                    </div>
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/frontend/img/logo-bitcoin.svg"
                          alt="Logo bitcoin"
                          class="object-contain max-h-full"
                        />
                      </button>
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/frontend/img/logo-american-express.svg"
                ...
                {{-- <div class="text-center"> --}}
                  <button type="submit" class="bg-primer text-black hover:bg-primer2 hover:text-white focus:outline-none w-full py-3 rounded-full text-lg focus:text-black transition-all duration-200 px-6">Checkout Now</button>
                {{-- </div> --}}
              </form>
            </div>
          </div>
